...
{
  description = "Nix flake for pythoneda-artifact/nix-flake";
  inputs = rec {
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        repo = "nix-flake";
        version = "0.0.10";
        sha256 = "15rh3vs232476k1csdh6lnih7n23v124gg8g9ghxp5r0nxz378n1";
        pname = "${org}-${repo}";
        ...
        pythoneda-artifact-nix-flake-for = { python
          ...
          in python.pkgs.buildPythonPackage rec {
            ...
            postInstall = with python.pkgs; ''
              ...
              command popd
              mkdir -p $out/dist $out/deps/flakes
              command cp dist/${wheelName} $out/dist
              for dep in ${pythoneda-shared-artifact-code-events} ${pythoneda-shared-code-requests-events} ${pythoneda-shared-code-requests-jupyterlab} ${pythoneda-shared-code-requests-shared} ${pythoneda-shared-nix-flake-shared} ${pythoneda-shared-pythonlang-domain}; do
      ...
      in rec {
        ...
        devShells = rec {
          default = pythoneda-artifact-nix-flake-python312;
          ...
          pythoneda-artifact-nix-flake-python313 = shared.devShell-for {
            banner = "${
                pythoneda-shared-pythonlang-banner.packages.${system}.pythoneda-shared-pythonlang-banner-python313
              }/bin/banner.sh";
            extra-namespaces = "";
            nixpkgs-release = nixpkgsRelease;
            package = packages.pythoneda-artifact-nix-flake-python313;
        ...
        packages = rec {
          ...
          pythoneda-artifact-nix-flake-python313 =
            pythoneda-artifact-nix-flake-for {
              python = pkgs.python313;
              pythoneda-shared-artifact-code-events =
